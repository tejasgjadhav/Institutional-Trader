...
| **T-1 EVE** (SENSEX weekly eve Wed, BANKNIFTY monthly eve; bear call 0.5% OTM, 6 strikes wide, 15:33 entry, held to settlement) | `T1_EVE_ENABLED` · **ADVISORY** | SENSEX 85.7% OOS-era · BNF +₹801/tr IS, 5/6 yrs | ~₹27k/yr + ~₹29k/yr modelled | deployed 17-Sep-2026 from studies/T1_CLOSE_ENTRY.md (1,405 trades 2019→2026). DIRECTIONAL (bear-call only) — own record, not headline P&L; NIFTY excluded (71.5% full-period); promote or kill at 30 fills |
